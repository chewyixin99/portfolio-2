...
const sphereTexts = [
  <Image width={100} height={100} src={"/../public/assets/tagsphere/react.png"} alt={"react"} key={""} />,
  // "ReactJS",
  <Image className="bg-[var(--color-text-secondary-dark)] px-2 py-1" width={65} height={65} src={"/../public/assets/tagsphere/next.png"} alt={"next"} key={""} />,
  // "NextJS",
  <Image className="bg-[var(--color-text-secondary-dark)] p-1" width={75} height={75} src={"/../public/assets/tagsphere/express.png"} alt={"express"} key={""} />,
  // "ExpressJS",
  <Image width={75} height={75} src={"/../public/assets/tagsphere/htmlcss.png"} alt={"htmlcss"} key={""} />,
  // "HTML",
  // "CSS",
  <Image width={150} height={150} src={"/../public/assets/tagsphere/mysql.png"} alt={"mysql"} key={""} />,
  // "MySQL",
  <Image width={100} height={100} src={"/../public/assets/tagsphere/tailwind.png"} alt={"tailwind"} key={""} />,
  // "Tailwind",
  <Image width={200} height={200} src={"/../public/assets/tagsphere/springboot.png"} alt={"springboot"} key={""} />,
  // "SpringBoot",
  <Image width={100} height={100} src={"/../public/assets/tagsphere/java.png"} alt={"java"} key={""} />,
  // "Java",
  ...
  // "Flutter",
  <Image width={100} height={100} src={"/../public/assets/tagsphere/vue.png"} alt={"vue"} key={""} />,
  // "VueJS",
  ...
  // "Bootstrap",
  <Image width={75} height={75} src={"/../public/assets/tagsphere/typescript.png"} alt={"typescript"} key={""} />,
  // "Typescript",
  <Image width={50} height={50} src={"/../public/assets/tagsphere/postgresql.png"} alt={"postgresql"} key={""} />,
  // "PostgreSQL",
  <Image width={100} height={100} src={"/../public/assets/tagsphere/python.png"} alt={"python"} key={""} />,
  // "Python",
  ...
  // "Jest",
  <Image width={75} height={75} src={"/../public/assets/tagsphere/php.png"} alt={"php"} key={""} />,
  // "PHP",
