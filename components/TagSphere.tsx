/* 
Full credits to Vallahad09
https://www.reddit.com/r/reactjs/comments/lfqe5o/3d_sphere_tag_cloud/
...
const sphereTexts = [
  <Image width={100} height={100} src={"/assets/tagsphere/react.png"} alt={"react"} key={""} />,
  // "ReactJS",
  <Image className="bg-[var(--color-text-secondary-dark)] px-2 py-1" width={65} height={65} src={"/assets/tagsphere/next.png"} alt={"next"} key={""} />,
  // "NextJS",
  <Image className="bg-[var(--color-text-secondary-dark)] p-1" width={75} height={75} src={"/assets/tagsphere/express.png"} alt={"express"} key={""} />,
  // "ExpressJS",
  <Image width={75} height={75} src={"/assets/tagsphere/htmlcss.png"} alt={"htmlcss"} key={""} />,
  // "HTML",
  // "CSS",
  <Image width={150} height={150} src={"/assets/tagsphere/mysql.png"} alt={"mysql"} key={""} />,
  // "MySQL",
  <Image width={100} height={100} src={"/assets/tagsphere/tailwind.png"} alt={"tailwind"} key={""} />,
  // "Tailwind",
  <Image width={200} height={200} src={"/assets/tagsphere/springboot.png"} alt={"springboot"} key={""} />,
  // "SpringBoot",
  <Image width={100} height={100} src={"/assets/tagsphere/java.png"} alt={"java"} key={""} />,
  // "Java",
  <Image width={50} height={50} src={"/assets/tagsphere/dart.png"} alt={"dart"} key={""} />,
  // "Dart",
  <Image width={50} height={50} src={"/assets/tagsphere/flutter.png"} alt={"flutter"} key={""} />,
  // "Flutter",
  <Image width={100} height={100} src={"/assets/tagsphere/vue.png"} alt={"vue"} key={""} />,
  // "VueJS",
  <Image width={50} height={50} src={"/assets/tagsphere/firebase.png"} alt={"firebase"} key={""} />,
  // "Firebase",
  <Image width={50} height={50} src={"/assets/tagsphere/bootstrap.png"} alt={"bootstrap"} key={""} />,
  // "Bootstrap",
  <Image width={75} height={75} src={"/assets/tagsphere/typescript.png"} alt={"typescript"} key={""} />,
  // "Typescript",
  <Image width={50} height={50} src={"/assets/tagsphere/postgresql.png"} alt={"postgresql"} key={""} />,
  // "PostgreSQL",
  <Image width={100} height={100} src={"/assets/tagsphere/python.png"} alt={"python"} key={""} />,
  // "Python",
  <Image className="bg-[var(--color-text-secondary-dark)] p-1" width={50} height={50} src={"/assets/tagsphere/flask.png"} alt={"flask"} key={""} />,
  // "Flask",
  <Image width={50} height={50} src={"/assets/tagsphere/jest.png"} alt={"jest"} key={""} />,
  // "Jest",
  <Image width={75} height={75} src={"/assets/tagsphere/php.png"} alt={"php"} key={""} />,
  // "PHP",
