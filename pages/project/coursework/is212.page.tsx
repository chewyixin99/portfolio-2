          ...
          <div className="project-page-body-col">
            ...
            <div>
              ...
              <p className="pb-3">
                ...
                environment, writing our user stories and then estimating them,
                and then finally holding our first sprint planning meeting.
              </p>
              <p className="py-3">
              ...
              <span className="project-description-list-item">
                ...
                : Version control, one that is most familiar by everyone in the
                team
              </span>
              <span className="project-description-list-item">
                <Link
              ...
              <p className="py-3">
                Jira also has Github support, allowing the team to easily track
                the branches, commits, and pull requests created for a Jira
                ticket at a glance.
              </p>
              <p className="py-3">
                After splitting the workload, we finally came up with most of
                the user stories required to complete in order to achieve the 5
                core functionalities of the first software release.
              </p>
              ...
              <p className="py-3">
                ...
                , while the rest of the stories were left to be assigned a story
                point at a later date due to uncertainties.
              </p>
              <p className="py-3">
                ...
                school curriculum, and what better way was there to learn a new
                skill than applying it on a project, right? <br />
                <br />
              ...
              <p className="py-3">
                As we are all juggling 3-4 other modules during the semester, we
              ...
              <p className="py-3">
                ...
                <span className="color-text-accent">Sprint Retrospective</span>{" "}
                is conducted to go over the work done during the sprint
                (completed or not), so that the team can learn from any mistakes
                or good practices exhibited by some members. This allows us to
                be able to conduct subsequent sprints more productively and
                efficiently. <br />
                <br />
              ...
              <p className="py-3">
                The content for unit tests were gone through pretty late in the
                semester, therefore we implemented these tests between sprint 2
                and sprint 3 of the process. Some code snippets of tests will be
                shown below.
              </p>
              <div className="project-page-image-container">
                <Image
              ...
              <p className="py-3">
                ...
                method in Jest to check if a given input into a method gives the
                expected output.
              </p>
              <div className="project-page-image-container">
                <Image
              ...
              <p className="py-3">
                ...
                and check if the return result from these calls are as expected.
                <br />
                <br />
                However, mocking API calls and data should not be used too much
                since there is a chance that the API may change in the future,
                and if the corresponding mock API in the tests are not updated,
                it may give the developer the{" "}
                <span className="color-text-accent">
                  &lsquo;illusion&rsquo;
                </span>{" "}
                that the new code is healthy, when in reality the tests were not
                updated to match the change in code.
              </p>
              ...
              <p className="py-3">
                ...
                , we were able to provide an environment that is always updated
                with the latest build for testing among the developers, as it is
                connected to the Github repository. This allows developers to
                work with a &rsquo;single source of truth&rsquo;
                (database-wise), so that we can be sure that our changes will be
                working for the rest as well, instead of just using localhost.
              </p>
              <div className="project-page-image-container">
                <Image
            ...
            <div>
              ...
              <p className="py-3">
                I&lsquo;ve also come to realize the importance of testing, to
                not only ensure the{" "}
