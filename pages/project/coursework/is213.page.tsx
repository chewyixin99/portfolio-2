        ...
        <div className="project-page-grid">
          <div className="project-page-body-col">
            ...
            <div>
              ...
              <p className="py-3">
                The key learning outcome of the project was for the team to
                build an enterprise solution that is based on the{" "}
                <Link
                  href="https://microservices.io/patterns/microservices.html"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <p className="pb-3">
                ...
                can replace both the manual ordering and payment processes,
                aiming to reduce the congestion and hassle experienced in
                hawkers during peak hours.
              </p>
            ...
            <div>
              ...
              <p className="pb-3">
                ...
                performs is to browse the hawkers and menu, followed by placing
                an order.
              </p>
              ...
              <p className="pb-3">
                A hawker is a tenant in a hawker center, and the main actions
                the hawker performs include accepting, rejecting, and completing
                food orders, updating their food menu, and viewing all orders
                and order history.
              </p>
              <div className="project-page-image-container">
                <Image
              ...
              <p className="py-3">
                ...
                <span className="project-description-list-item">
                  Customer uses the UI to invoke the hawker service, making a
                  HTTP GET request. In this case, a GET request to{" "}
                  <em>/hawker/halal/1</em> was made to get all hawkers that are
                  halal-certified, illustrated by steps 1 and 2 on the left
                  diagram.
                </span>
                <span className="project-description-list-item">
                  Customer then chooses a hawker to order from, and then add
                  items to a cart.
                </span>
                <span className="project-description-list-item">
                  Customer invokes the <em>Place Order</em> microservice by
                  making a POST request, which orchestrates the &lsquo;place
                  order&rsquo; process.
                </span>
                <span className="project-description-list-item">
                  A <span className="color-text-accent">validation check</span>{" "}
                  is made to ensure that the customer has enough money in the
                  wallet. The process ends if there is insufficient balance.
                </span>
                <span className="project-description-list-item">
                ...
                <span className="project-description-list-item">
                  If there are zero errors, the order is successfully created,
                  and the customer get&rsquo;s an SMS notification confirming
                  their order.
                </span>
              </p>
              <p className="py-3">
            ...
            <div>
              ...
              <p className="py-3">
                Finally, this project also allowed me to learn a little more
                about the{" "}
                <Link
            ...
            <div>
              ...
              <p className="py-3">
                I thoroughly enjoyed and took away many lessons from this
                module, and it is without a doubt one of my favorite module in
                SMU. However, for a simple project such as this, making use of
                microservices may be a little bit of an overkill and I doubt I
                will be applying many concepts learnt here on other projects.
                But hey, it doesn&rsquo;t hurt to learn new things, does it? 😄
              </p>
              <p className="py-3">
                This is just a introductory module to the world of backend
                development and hosting applications, just to get our feet wet.
                I know that the project is (in many ways) neither perfect nor
