        ...
        <div className="project-page-grid">
          <div className="project-page-body-col">
            ...
            <div>
              ...
              <p className="py-3">
                This project was done as part of a requirement for a module I
                took in SMU, Web Application and Development II (WAD II). It is
                the school&rsquo;s introductory module to webpage and frontend
                design, and it was also my first touch point with a frontend
                framework which was{" "}
                <Link
              ...
              <p className="italic pb-3">
                &ldquo;To organise this fragmented network of basketball games
                in Singapore to help users better visualise the availability of
            ...
            <div>
              ...
              <p className="pb-3">
                By entering an area, or clicking on &lsquo;Courts Near
                Me&rsquo;, users will be able to easily visualize and select a
                court on the user interface. This is made possible using Google
                Maps API. The relevant code snippet can be found in the file{" "}
                <span className="color-text-accent italic">
                  courtMiniMap.js
                </span>{" "}
                in the source code.
              </p>
              ...
              <p className="pb-3">
                Users will be able to visualize the current traffic of people
                who have checked in at a specific basketball court, and
                thereafter decide if they wish to create, join or leave a team
                as they see fit. Users are also able to separately bookmark a
                court should they foresee themself visiting the court again in
                the future.
              </p>
              <div className="project-page-image-container">
                <Image
              ...
              <p className="pb-3">
                Frequent ballers and regulars have the option to form a
                community to facilitate organizing and scheduling of pickup
                games. There is also a message board which acts as a
                announcement broadcast for members within a group.
              </p>
              <div className="project-page-image-container">
                <Image
            ...
            <div>
              ...
              <p className="py-3">
                ...
                done in SMU, utilising a frontend framework such as Vue, and
                also me and my team&rsquo;s first time developing a web
                application that is{" "}
                <span className="color-text-accent">
              ...
              <p className="py-3">
                ...
                project, from ideating all the way till the first release and
                demo day.
              </p>
            </div>
          </div>
