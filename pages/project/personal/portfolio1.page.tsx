            ...
            <div>
              ...
              <div>
                ...
                <p className="py-3">
                  ...
                  creating a web-application from scratch, and I wasn&lsquo;t
                  too sure how or even where to even start from. The inertia is
                  real. After weeks of procrastination since the start of my
                  holidays, I finally decided to create my first application (
                ...
                <p className="py-3">
                  ...
                  . I was absolutely clueless as to what a framework or even
                  what JavaScript is. Therefore it would make sense that I used
                  whatever knowledge I have and attempt to apply it onto some
                  sort of website.
                </p>
              ...
              <div>
                ...
                <p className="py-3">
                  ...
                  scratch&rdquo;, browsed through a few videos, and finally
                  chose the one design that I liked the most, nothing too fancy
                  of a process. The tutorial that ultimately led to the start of
                  my web-application journey is one by{" "}
                  <Link
              ...
              <div>
                ...
                <p className="py-3">
                  ...
                  page which allows users to enter their name and a comment,
                  which would then be stored in a MySQL database and reflected
                  on the frontend after the user refreshes the page.
                  Unfortunately, it is not working at the time of this writing.
                </p>
                <p className="py-3">
                ...
                <p className="py-3">
                  ...
                  multiple files just to edit the component. This moment was
                  when I had my first coding epiphany, and I proceeded to{" "}
                ...
                <div className="project-page-image-container">
                  <Image
                    src={
                      "/assets/projects/portfolio1/code-snippet-component.jpg"
                    }
                    width={500}
                    height={500}
                ...
                <p className="py-3">
                  While this is definitely not the best way to do things, 2020
                  me was proud and thoroughly satisfied that I manage to reduce
              ...
              <div>
                ...
                <p className="py-3">
                  ...
                  my code{" "}
                  <span className="color-text-accent">come to live</span> each
                  time I made changes which was being reflected on the website
                  immediately.
                </p>
                <p className="py-3">
                  ...
                  , and there is no single person who knows everything at the
                  back of their hand. Technology is continuously improving and
                  what I learn today may become obsolete tomorrow. This mindset
                  shift was what allowed me to realize that{" "}
                  <span className="color-text-accent">
